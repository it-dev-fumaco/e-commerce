                  ...
                  <div class="equal-column-content">
                    ...
                    <div class="hover-container product-card" style="position: relative">
                      ...
                      <picture>
                        ...
                        <img src="{{ asset($img_bs) }}" alt="{{ Str::slug($bs['alt'], '-') }}" class="img-responsive hover" style="width: 100% !important; height: 100% !important" loading="lazy">
                      </picture>
                    </div>
                  ...
                  <div class="equal-column-content">
                    ...
                    <div class="hover-container product-card" style="position: relative !important;">
                      ...
                      <picture>
                        ...
                        <img src="{{ asset($img_os) }}" alt="{{ Str::slug($os['alt'], '-') }}" class="img-responsive hover" style="width: 100% !important; height: 100% !important" loading="lazy">
                      </picture>
                    </div>
                    <div class="card-body d-flex flex-column">
                      <div class="text ellipsis">
