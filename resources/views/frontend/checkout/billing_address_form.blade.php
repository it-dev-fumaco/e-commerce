...
// $tempid_1 = $_SESSION["buyer_id"];

// $item_x_db = "SELECT * FROM fumaco_temp WHERE xtempcode = '$tempid_1' AND xstatus='1'";
// $data_xdb1 = $fumaco_conn ->query($item_x_db);
// if ($data_xdb1->num_rows > 0) {
// while($data_x_1 = $data_xdb1->fetch_assoc())
//     {

//       $x_data0_fumaco = $data_x_1["xtempcode"];
//       $x_data1_fumaco = $data_x_1["xfname"];
//       $x_data2_fumaco = $data_x_1["xlname"];
//       $x_data3_fumaco = $data_x_1["xadd1"];
//       $x_data4_fumaco = $data_x_1["xadd2"];
//       $x_data5_fumaco = $data_x_1["xprov"];
//       $x_data6_fumaco = $data_x_1["xcity"];
//       $x_data7_fumaco = $data_x_1["xbrgy"];
//       $x_data8_fumaco = $data_x_1["xpostal"];
//       $x_data9_fumaco = $data_x_1["xcountry"];
//       $x_data10_fumaco = $data_x_1["xaddresstype"];
//       $x_data11_fumaco = $data_x_1["xemail"];
//       $x_data12_fumaco = $data_x_1["xmobile"];
//       $x_data13_fumaco = $data_x_1["xcontact"];
...
//   $x_data7_fumaco = "";
//   $x_data8_fumaco = "";
//   $x_data9_fumaco = "-- Select country --";
//   $x_data10_fumaco = "-- Select Address Type --";
//   $x_data11_fumaco = "";
//   $x_data12_fumaco = "";
//   $x_data13_fumaco = "";
...
?>
	...
	<main style="background-color:#ffffff; min-height: 700px;" class="products-head">
		<div class="container" style="padding-left:5% !important; padding-right:5% !important;">
			<form action="cart-ZnVtYWNhcnQz" id="contactid">
				...
				<div class="row">
					<div class="col">
						...
						<input type="email" class="form-control formslabelfnt" id="eaddress" name="eaddress" required>
					</div>
					<div class="col">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<center>
								...
								<input type="submit" class="btn btn-lg btn-outline-primary" id="shipbilling" value="PROCEED">
							</center>
						</div>
					</div>
				</div>
	...
	<script>
	function shipp_function() {
		var checkBox = document.getElementById("myCheck");
		if (checkBox.checked == true){
			$("#shipbilling").val("PROCEED");
			$("#contactid").attr('action', 'cart-ZnVtYWNhcnQz');
		} else {
			$("#shipbilling").val("PROCEED TO SHIPPING ADDRESS");
			$("#contactid").attr('action', 'shipping-cart-ZnVtYWNhcnQy?x=1');
		}
	}
	</script>
@endsection