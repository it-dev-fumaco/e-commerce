<div class="col-md-4 col-lg-{{ isset($col) ? $col : '3' }} animated animatedFadeInUp fadeInUp equal-height-columns mb-3 best-selling-card">
  <!-- {{ $item['item_code'] }} -->
  <div class="card {{ isset($activePage) && $activePage == 'product_page' ? null : 'product_page' }} w-100">
    @if (isset($activePage) && $activePage == 'product_page')
    <div class="border">
    @endif
      ...
      @if ($item['on_stock'])
        <div class="row col-11 mx-auto">
          <span class="mt-2 mb-2 text-success p-0 {{ isset($activePage) && $activePage == 'homepage' ? 'd-none' : null }}" style="font-weight: 600;">Available</span>
