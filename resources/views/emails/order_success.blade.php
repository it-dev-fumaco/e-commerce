			...
			<table border="0" style="width: 100%; border-collapse: collapse;">
				...
				<tfoot>
					...
					<tr style="font-size: 0.9rem; text-align: right; border-top: 2px solid;">
						...
						<td class="pb-1 pt-1" style="padding: 8px;"><b>₱ {{ number_format(str_replace(",","",($order['order_details']->order_shipping_amount + ($order['order_details']->order_subtotal - $order['order_details']->discount_amount))), 2) }}</b></td>
					</tr>
