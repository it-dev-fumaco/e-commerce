		...
		<div class="container-fluid">
			<div class="row">
							...
							<table class="table table-bordered table-hover">
                              ...
                              <th class="text-center">Action</th>
								...
								<tbody>
									...
									<tr>
										<td class="text-center">{{ $item->f_parent_code }} - {{ $item->f_parent_item_name }}</td>
										<td class="text-center">
											<a href="{{ request()->fullUrlWithQuery(['parent' => $item->f_parent_code, 'name' => $item->f_parent_item_name]) }} " class="btn btn-secondary">Edit</a>
										</td>
									</tr>
									@empty
									<tr>
				...
				<div class="col-md-8">
					<div class="card">
						<!-- /.card-header -->
						<form action="/admin/attribute_status/{{ request()->parent }}/update" method="POST">
							@csrf
							<div class="card-body">
								...
								@endif
								<h4 class="text-center">{{ 'Attibutes of '. request()->parent . ' - ' . request()->name }}</h4>
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
										...
										<tr>
											...
											<td class="text-center">
												<div class="custom-control custom-checkbox">
													<input type="hidden" name="show_in_website[]" value="{{ $attr->attribute_status }}">
													<input class="custom-control-input cb-siw" type="checkbox" id="cb{{ $i }}" {{ $attr->attribute_status == 1 ? 'checked' : '' }}>
