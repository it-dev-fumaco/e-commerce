<table class="table table-bordered table-hover">
    <thead class="text-center">
        <tr>
            ...
            <td class="p-1">Est. Delivery Date</td>
                    ...
                    <div class="modal-dialog modal-xl" style="min-width: 70%;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="customer-order-{{ $order['order_no'] }}">
                                @if (!in_array($status, ['cancelled', 'completed', 'Cancelled', 'Completed']))
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <form class="btn-group" action="/admin/order/status_update" method="POST" style="width: 100%; height: 40px !important;">
                                                        ...
                                                        <select name="status" class="form-control col-md-6" name="order_status" required {{ $update_status }}> 
                                                            ...
                                                            @foreach($order['order_status'] as $o_status)
                                                                <option value="{{ $o_status->status }}" {{ $order['status'] == $o_status->status ? 'selected disabled' : '' }}>{{ $o_status->status }}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="d-none">
...
<div id="orders-table-pagination" class="float-right mt-4" data-status="{{ $status }}">
