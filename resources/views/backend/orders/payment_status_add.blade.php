				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">Add Payment Status</li>
						</ol>
					</div>
				</div>
			</div><!-- /.container-fluid -->
					...
					<div class="col-6">
						<div class="card card-primary">
							<div class="card-body">
                                ...
                                @endif
                                <form action="/admin/payment/status/add" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-9"><h4>Add Payment Status</h4></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <br/>&nbsp;
                                        <div class="col-12">
                                            <label><input type="checkbox" name="updates_status"> Updates Payment Status</label>
                                        </div>
                                    </div>
                                </form>
                            </div>
