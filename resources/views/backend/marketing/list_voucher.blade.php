                                                        ...
                                                        <tr>
                                                            ...
                                                            {{-- <td class="text-center">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                                        <a class="dropdown-item" href="/admin/marketing/voucher/{{ $exp_c->id }}/edit_form">View Details</a>
                                                                    </div>
                                                                </div>
                                                            </td> --}}
                                                        </tr>
                                                        {{-- <div class="modal fade" id="delete{{ $exp_c->id }}" role="dialog" aria-labelledby="delete{{ $exp_c->id }}Label" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">Delete "On Sale"</h5>
