/********************************************************************************************************************
        ...
        Developer : Dhok Pochie (dhokpochie28@gmail.com)


********************************************************************************************************************/

function Loading(Checker, callback) {
    var LoadingImage = "https://test.fumaco.com.ph/assets/loading_flower.gif"; //29x29
    ...
    if (typeof (Checker) == "boolean") {
        ...
        if (Checker) {
            if (document.getElementById("LoadingDivLayer") == null) {
                ...
                loadingTag += "<div class=\"LoadingBox\" style=\"top:20%;left:" + String(posX) + "px;\">";
