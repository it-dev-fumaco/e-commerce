...
Route::group(['middleware' => ['sanitation', 'throttle:global']], function(){
    ...
    Route::namespace('Auth')->group(function(){
        ...
        Route::post('login/facebook', 'LoginController@loginFbSdk')->name('facebook.login');
...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function(){
        ...
        Route::group(['middleware' => 'otp_status_check'], function(){ // Check for OTP
            Route::middleware(['check_erp_status'])->group(function () { // check erp status before submission for put, post, and delete Routes
